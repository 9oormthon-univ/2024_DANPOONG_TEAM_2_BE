...
@Builder
public record MyPundingHistoryResDto(
        int totalMileageAmount,
        List<HistoryInfoResDto> historyInfoResDtos
) {
    public static MyPundingHistoryResDto of(int totalMileageAmount, List<HistoryInfoResDto> historyInfoResDtos) {
        return MyPundingHistoryResDto.builder()
